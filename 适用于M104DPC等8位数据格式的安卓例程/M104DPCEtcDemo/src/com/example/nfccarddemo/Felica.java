...
public class Felica extends Activity {
	final int TRUE = 1;
	final int FALSE = 0;
	...
	public void rfInitTypeFun() 
	{
		...
		nStatus = myzrfidAPI.rfInitType(nfd, 0, (byte)('C'));
		if(nStatus==TRUE)
		{
	...
	public void rfFelicaGetUidFun() 
	{
		...
		nStatus = myzrfidAPI.rfFelicaGetUid(nfd, 0, pUID, pLen);
		if(nStatus==TRUE)
		{
			tvInfo.setText(R.string.RfFelica_OK);
			tvResult.setText(ByteArrayToString(pUID,(int)(pLen[0])));
		}
		else
		{
			tvInfo.setText(R.string.RfFelica_Err);
		}	
	}
	public void MainShowDlg() 
	{
		Intent intent = new Intent(Felica.this,MainActivity.class);
